...
contract LotteryWithTickets {
    ...
    //Limita alcune funzioni al solo manager.
    modifier restricted() {
        require(msg.sender == manager, "Solo il manager puo' chiamare questa funzione");
        _;
    }

    // Consente l'azione solo se la lotteria è aperta.
    ...
    //Consente l'azione solo se la lotteria è chiusa.
    ...
    //Cambia il prezzo del biglietto.
    ...
    /**
     * Funzione per scegliere il vincitore.
    ...
    /**
     * Funzione per acquistare biglietti.
    ...
    //Permette al vincitore di ritirare i fondi in modo sicuro (pattern CEI).
    ...
    //Funzione per visualizzare i biglietti acquistati.
     ...
     * NON sicuro in produzione: i miner possono influenzare block.prevrandao
     * e block.timestamp. Per ambienti reali si usa Chainlink VRF.
     */
